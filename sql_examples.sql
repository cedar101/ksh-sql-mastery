...
INSERT INTO city VALUES ('부산',765,342,'y','경상');
INSERT INTO city VALUES ('오산',42,21,'n','경기');
INSERT INTO city VALUES ('청주',940,83,'n','충청');
INSERT INTO city VALUES ('전주',205,65,'n','전라');
INSERT INTO city VALUES ('순천',910,27,'n','전라');
INSERT INTO city VALUES ('춘천',1116,27,'n','강원');
INSERT INTO city VALUES ('홍천',1819,7,'n','강원');
...
INSERT INTO staff VALUES ('김유신','총무부','남','2000-2-3','이사',420,88.8);
INSERT INTO staff VALUES ('유관순','영업부','여','2009-3-1','과장',380,NULL);
INSERT INTO staff VALUES ('안중근','인사과','남','2012-5-5','대리',256,76.5);
INSERT INTO staff VALUES ('윤봉길','영업부','남','2015-8-15','과장',350,71.25);
INSERT INTO staff VALUES ('강감찬','영업부','남','2018-10-9','사원',320,56.0);
INSERT INTO staff VALUES ('정몽주','총무부','남','2010-9-16','대리',370,89.5);
INSERT INTO staff VALUES ('허난설헌','인사과','여','2020-1-5','사원',285,44.5);
INSERT INTO staff VALUES ('신사임당','영업부','여','2013-6-19','부장',400,92.0);
INSERT INTO staff VALUES ('성삼문','영업부','남','2014-6-8','대리',285,87.75);
INSERT INTO staff VALUES ('논개','인사과','여','2010-9-16','대리',340,46.2);
INSERT INTO staff VALUES ('황진이','인사과','여','2012-5-5','사원',275,52.5);
INSERT INTO staff VALUES ('이율곡','총무부','남','2016-3-8','과장',385,65.4);
INSERT INTO staff VALUES ('이사부','총무부','남','2000-2-3','대리',375,50);
INSERT INTO staff VALUES ('안창호','영업부','남','2015-8-15','사원',370,74.2);
INSERT INTO staff VALUES ('을지문덕','영업부','남','2019-6-29','사원',330,NULL);
INSERT INTO staff VALUES ('정약용','총무부','남','2020-3-14','과장',380,69.8);
INSERT INTO staff VALUES ('홍길동','인사과','남','2019-8-8','차장',380,77.7);
INSERT INTO staff VALUES ('대조영','총무부','남','2020-7-7','차장',290,49.9);
INSERT INTO staff VALUES ('장보고','인사과','남','2005-4-1','부장',440,58.3);
INSERT INTO staff VALUES ('선덕여왕','인사과','여','2017-8-3','사원',315,45.1);
...
SELECT "name", area, population, metro, region FROM city;
SELECT * FROM city;

SELECT "name" AS 도시명, area AS "면적(제곱Km)", population AS "인구(만명)" FROM city;

SELECT 도시명 = "name", area '면적(제곱Km)', population [인구(만명)] FROM city;

SELECT "name", population * 10000 AS "인구(명)" FROM city;

SELECT "name", area, population, population * 10000 / area AS "인구밀도" FROM city;
...
SELECT * FROM city WHERE population >= 100 AND area >= 700;

SELECT * FROM city WHERE region = '경기' AND population >= 50 OR area >= 500;
SELECT * FROM city WHERE region = '경기' AND (population >= 50 OR area >= 500);
...
SELECT * FROM city WHERE population BETWEEN 50 AND 100;

SELECT * FROM city WHERE population >= 50 AND population <= 100;
...
SELECT region, "name", area, population FROM city ORDER BY region, "name" DESC;
...
SELECT "name", population * 10000 / area FROM city ORDER BY population * 10000 / area;
...
SELECT TOP 20 PERCENT * FROM city ORDER BY population DESC;
...
(
	...
	population INT NULL ,
	metro CHAR(1) NOT NULL,
	CONSTRAINT PK_city_name_region PRIMARY KEY ("name", region)
);
